...
export const ProductAdCard: React.FC<ProductAdCardProps> = ({ content }) => {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden mt-8">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        <div className="flex items-center">
          <MegaphoneIcon className="h-6 w-6 mr-3 text-sky-500" />
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white">AI-Generated Product Ad</h3>
        </div>
